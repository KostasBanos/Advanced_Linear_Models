...
#| warning: false
#| message: false
ggplot(mydata, aes(x = log_gdp, y = n, color = factor(wealthy_class), group = wealthy_class)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "glm", formula = 'y ~ x', method.args = list(family = quasipoisson), se = FALSE) +
  labs(
...
ggplot(mydata, aes(x = log_pop, y = n, color = factor(wealthy_class), group = wealthy_class)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "glm", formula = 'y ~ x', method.args = list(family = quasipoisson), se = FALSE) +
  labs(
    title = "Gold Medals vs Log Pop by Wealth Class",
    x = "Log Pop",
    y = "Number of Gold Medals",
    color = "Wealth Class"
  ) +
...
ggplot(mydata, aes(x = centered_log_pop, y = log_gdp, colour = team)) +
  geom_point(alpha = 0.5) +
  stat_ellipse(aes(fill = team), geom = "polygon", alpha = 0.2) +
  theme(legend.position = "none") +
  labs(title = "Elliptical Clusters of GDP and Population by Team", x = "Centered Log(Population)", y = "Log(GDP)")
